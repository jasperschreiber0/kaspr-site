      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        <div className="bg-white rounded-2xl border border-stone-200 p-8 md:p-12">
          ...
          <Section title="3. Subscriptions and Pricing">
            <p>Subscription tiers (Revive, Revive + Grow, Full Stack) and pricing are detailed on our website in Australian dollars. Founding client pricing (50% lifetime discount) is available to the first ten subscribers, is non-transferable, and requires continuous active subscription.</p>
          </Section>
          ...
          <Section title="8. Your Clients' Customer Data">
            <p>You represent and warrant that:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li>You have obtained all necessary consents to contact customers via WhatsApp and SMS</li>
              <li>You will honour opt-out requests (Kaspr's STOP handler does this automatically)</li>
              <li>Your contact lists comply with the Spam Act 2003 (Cth) and Do Not Call Register Act 2006 (Cth)</li>
            </ul>
            <p>You are the data controller for your customers' data. Kaspr processes it as your data processor per our Privacy Policy.</p>
          </Section>
